...
void main() {
    ...
    int buffer[8];
    //File stuff below
    FILE* out = fopen("binary_from_text.dat","wb"); //write it to a .dat file as binary
    FILE* in = fopen("a_secondfile.txt","r"); //This file can be anything that has 0's and 1's
